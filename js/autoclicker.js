class DiplomaAutoclicker {
    ...
    addText() {
        ...
        // Добавляем пробел + слово + знак препинания
        // Если это первое слово в тексте — пробел не нужен
        if (this.currentText.length === 0 || this.currentText.endsWith('\n\n')) {
            // Начало текста или новый абзац — без пробела, но с большой буквы
        ...
        // 5% шанс начать новый абзац
        if (Math.random() < 0.05 && this.currentText.length > 100) {
